...
class ChartPainter extends CustomPainter {
  ...
  ChartPainter(Chart chart, Animation<double> selectedFade,
  ...
  void paintChartData(
    ...
    final dataOffset = (int index) {
      final x =
          ((index.toDouble() - chart.domainStart) / range) * size.width + 28;
  ...
  void paint(canvas, size) {
    ...
    if (_chart.selectedDataPoint != -1) {
      ...
      final x =
          ((_chart.selectedDataPoint.toDouble() - _chart.domainStart) / range) *
                  size.width +
              28;
