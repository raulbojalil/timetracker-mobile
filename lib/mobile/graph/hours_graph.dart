...
class HoursGraph extends StatefulWidget {
  final Chart chart;

  HoursGraph({this.chart});

  @override
  State createState() => _HoursGraphState();
}

class _HoursGraphState extends State<HoursGraph>
  ...
  void initState() {
    _controller = AnimationController(
        vsync: this, duration: Duration(milliseconds: 600), value: 1.0);
